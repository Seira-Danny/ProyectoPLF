...
function getDatos(numeroJuegos) {
    const jugadores = [
        new Persona("Daniel"),
    ...
    for (let numberPartida = 0; numberPartida < numeroJuegos; numberPartida++) {
        //Creamos las fichas para el juego
        let fichasTotales = crearFichas();
        ...
        jugadores[sinFichas(jugadores)].ganadas += 1;
    }
    return jugadores;
}
